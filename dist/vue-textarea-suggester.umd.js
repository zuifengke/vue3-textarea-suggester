(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["vue-textarea-suggester"] = {}, global.Vue));
  ...
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, [(Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList($props.number, function (d, i) {
      return Vue.openBlock(), Vue.createElementBlock("i", {
        key: i,
        style: Vue.normalizeStyle($options.dotStyle(i))
      }, null, 4 /* STYLE */);
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    var _component_vue_loading = Vue.resolveComponent("vue-loading");
    return Vue.openBlock(), Vue.createElementBlock("div", {
      class: "suggester",
    ...
    }, [Vue.withDirectives(Vue.createElementVNode("ul", _hoisted_1, [Vue.withDirectives(Vue.createElementVNode("li", null, [Vue.createVNode(_component_vue_loading)], 512 /* NEED_PATCH */), [[Vue.vShow, $props.remote && $props.loading]]), (Vue.openBlock(true), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList($data.data, function (d, i) {
      return Vue.openBlock(), Vue.createElementBlock("li", {
        class: Vue.normalizeClass(["suggester-list-item", {
        ...
        return [Vue.createElementVNode("strong", null, Vue.toDisplayString(d.label), 1 /* TEXT */)];
      })], 10 /* CLASS, PROPS */, _hoisted_2);
    }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[Vue.vShow, $data.matchedStr]])], 4 /* STYLE */);
  }
